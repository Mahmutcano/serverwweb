...
const Miras = () => {
  return (
    <section id="miras" className="pt-28 md:pt-20 lg:pt-60">
          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="font-small mb-12 text-base !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                Miras hukuku, bir kişinin ölümü sonrası mal varlığının
                mirasçılara dağıtılması ve mirasçıların haklarını düzenler.
              </p>
