...
const Is = () => {
  return (
    <section id="ıs " className="pt-28 md:pt-20 lg:pt-60">
          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="font-small mb-12 text-base !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                İş hukuku, işçi ve işveren ilişkilerini düzenler. İşçi hakları,
                iş sözleşmeleri, işten çıkarmalar gibi konulara odaklanır.
              </p>
