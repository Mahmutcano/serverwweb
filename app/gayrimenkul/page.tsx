...
const Gayrimenkul = () => {
  return (
    <section id="gayrimenkul " className="pt-28 md:pt-20 lg:pt-60">
          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="font-small mb-12 text-base !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                Gayrimenkul hukuku, taşınmaz malların (gayrimenkullerin)
                alım-satımı, kiralanması, mülkiyeti ve ilişkili yasal konuları
                düzenler.
              </p>
